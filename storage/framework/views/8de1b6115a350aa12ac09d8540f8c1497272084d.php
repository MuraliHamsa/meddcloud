    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if(Auth::user()->group[0]['name'] == 'admin'): ?>
                ...
                <li class="treeview <?php echo e(Active::pattern(['payment', 'payment-billing', 'pharmacy', 'payment-category', 'expense', 'expense-category', 'financial-report'])); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-money"></i><?php echo e(trans('menu.backend.sidebar.financial-activities.payment')); ?><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                        <li><a href="<?php echo e(route('admin.payment.index')); ?>"><i class="fa fa-money"></i><?php echo e(trans('menu.backend.sidebar.billing.payment')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.pharmacy.index')); ?>"><i class="fa fa-money"></i><?php echo e(trans('menu.backend.sidebar.billing.pharmacy')); ?></a></li>
                        </ul>
                    </li>
            ...
            <?php if(in_array(Auth::user()->group[0]['name'], ['admin', 'Laboratorist', 'Doctor'])): ?>
                <li class="treeview <?php echo e(Active::pattern(['report-type', 'report'])); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo e(route('admin.echoreport.create')); ?>"><i class="fa fa-edit"></i>Echo Report</a></li>
                            <li><a href="<?php echo e(route('admin.radiologyreport.create')); ?>"><i class="fa fa-edit"></i>Radiology Report</a></li>
                            <li><a href="<?php echo e(route('admin.labreport.create')); ?>"><i class="fa fa-edit"></i>Lab Report</a></li>
                            <li><a href="<?php echo e(route('admin.dischargesummary.create')); ?>"><i class="fa fa-edit"></i>Discharge Summary</a></li>
                        </ul>
                 </li>
             <?php endif; ?>
