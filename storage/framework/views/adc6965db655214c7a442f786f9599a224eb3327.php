<?php $__env->startSection('htmlheader_title', trans('labels.backend.human_resources.accountant.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.human_resources.accountant.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.human_resources.accountant.create')); ?>
        ...
        <div class="box-body">
          <table id="accountant-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.human_resources.accountant.table.name')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.accountant.table.email')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.accountant.table.phone')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('accountant.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('accountant.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('accountant._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#accountant-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.accountant.get")); ?>',
          type: 'get',
    ...
    $(document).ready(function () {
      ...
      $('#accountant-table').on('click', '.edit-accountant', function(e){
        ...
        $.ajax({
          ...
          if(response.image){
            $('#edit-image').attr('src', '<?php echo e(config("medcloud.image_url")); ?>' + 'accountant/' + response.image)
          }
        });
      });
