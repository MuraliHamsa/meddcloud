<?php $__env->startSection('htmlheader_title', trans('labels.backend.human_resources.nurse.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.human_resources.nurse.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.human_resources.nurse.create')); ?>
        ...
        <div class="box-body">
          <table id="nurse-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.human_resources.nurse.table.name')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.nurse.table.email')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.nurse.table.phone')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('nurse.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('nurse.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('nurse._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#nurse-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.nurse.get")); ?>',
          type: 'get',
    ...
    $(document).ready(function () {
      ...
      $('#nurse-table').on('click', '.edit-nurse', function(e){
        ...
        $.ajax({
          ...
          if(response.image){
            $('#edit-image').attr('src', '<?php echo e(config("medcloud.image_url")); ?>' + 'nurse/' + response.image)
          }
        });
      });
