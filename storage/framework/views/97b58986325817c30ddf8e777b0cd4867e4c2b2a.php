<?php $__env->startSection('htmlheader_title', trans('labels.backend.bed.bed-allotment.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.bed.bed-allotment.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.bed.bed-allotment.create')); ?>
        ...
        <div class="box-body">
          <table id="bed-allotment-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-allotment.table.bedId')); ?> </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-allotment.table.patient')); ?> </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-allotment.table.allotted_time')); ?> </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-allotment.table.discharge_time')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('bed_allotment.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('bed_allotment.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('bed_allotment._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('after-scripts-end'); ?>
    ...
    <?php echo e(Html::script("js/locales.js")); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#bed-allotment-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.bed-allotment.get")); ?>',
          type: 'get',
