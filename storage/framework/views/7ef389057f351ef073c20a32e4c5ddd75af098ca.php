...
<div class="box-body">
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <?php echo e(Form::select('patient_id', $poption, @$payment->patient_id, ['class' => 'form-control patientinfo'], ['id' => 'patientid'])); ?>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <?php if(!empty(@$pharmacy->pharmacy_drugs)): ?>
        <?php foreach($pharmacy->pharmacy_drugs  as $medicine): ?>
         <div class="col-md-12 payment ">
            <div class="col-md-3 payment_label" style="width: 20%">
            ...
            <div class="col-md-2 payment_label" style="width: 20%">
                ...
                <i id="<?php echo e($medicine->id); ?>" title="Remove "  class="fa fa-times payment-del fa-2x category-minus" style="color: red;cursor: hand;cursor: pointer; float: right;"></i>
            </div>
          </div>
        <?php endforeach; ?>
      <?php endif; ?>
    ...
    <div class="col-lg-6">
      ...
      <div class="col-md-12 payment">
        <div class="col-md-4 payment_label" style="width: 40%">
          ...
          <label><?php echo e(ucfirst($medicine->name)); ?></label>
        </div>
        <div class="col-md-4 payment_label" style="width: 40%">
        ...
        <div class="col-md-4 payment_label" style="width: 15%; text-align: left;">
          <i id="<?php echo e($medicine->id); ?>" class="fa fa-plus-circle fa-2x category-add category-total" title="Add <?php echo e($medicine->medicine); ?> to final bill " style="color: green;cursor: hand;cursor: pointer; float: right;"></i>
        </div>
      </div>
      <?php endforeach; ?>
      <?php endif; ?>
