<?php $__env->startSection('htmlheader_title', trans('labels.backend.donor.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.donor.title')); ?>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.donor.create')); ?>
        ...
        <div class="box-body">
          <table id="donor-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.donor.table.name')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.group')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.age')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.sex')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.last_donation')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.phone')); ?> </th>
                <th> <?php echo e(trans('labels.backend.donor.table.email')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('donor.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('donor.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('donor._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('after-scripts-end'); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#donor-table').DataTable({
        processing: true,
        serverSide: true,
        "sScrollX": "100%", 
        "sScrollXInner": "100%", 
        ...
        ajax: {
          url: '<?php echo e(route("admin.donor.get")); ?>',
          type: 'get',
    ...
    $(document).ready(function () {
      ...
      $('#donor-table').on('click', '.edit-donor', function(e){
        e.preventDefault(e); 
