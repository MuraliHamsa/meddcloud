<?php $__env->startSection('htmlheader_title', trans('labels.backend.financial-activities.payment-billing.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.financial-activities.payment-billing.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.financial-activities.payment-billing.create')); ?>
        ...
        <div class="box-body">
          <table id="payment-billing-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.financial-activities.payment-billing.table.name')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('payment_billing.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 
  <?php echo $__env->make('payment_billing._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#payment-billing-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.payment-billing.get")); ?>',
          type: 'get',
