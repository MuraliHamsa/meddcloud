<?php $__env->startSection('htmlheader_title', trans('labels.backend.human_resources.transcriptionist.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.human_resources.transcriptionist.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.human_resources.transcriptionist.create')); ?>
        ...
        <div class="box-body">
          <table id="transcriptionist-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.human_resources.transcriptionist.table.name')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.transcriptionist.table.email')); ?> </th>
                <th> <?php echo e(trans('labels.backend.human_resources.transcriptionist.table.phone')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('transcriptionist.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('transcriptionist.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('transcriptionist._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#transcriptionist-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.transcriptionist.get")); ?>',
          type: 'get',
    ...
    $(document).ready(function () {
      ...
      $('#transcriptionist-table').on('click', '.edit-transcriptionist', function(e){
        ...
        $.ajax({
          ...
          if(response.image){
            $('#edit-image').attr('src', '<?php echo e(config("medcloud.image_url")); ?>' + 'transcriptionist/' + response.image)
          }
        });
      });
