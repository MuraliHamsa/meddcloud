<?php $__env->startSection('htmlheader_title', trans('labels.backend.bed.bed-category.title')); ?>

<?php $__env->startSection('contentheader_title', trans('labels.backend.bed.bed-category.title')); ?>
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              <?php echo e(trans('labels.backend.bed.bed-category.create')); ?>
        ...
        <div class="box-body">
          <table id="bed-category-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-category.table.category')); ?> </th>
                <th> <?php echo e(trans('labels.backend.bed.bed-category.table.description')); ?> </th>
...
<?php $__env->startSection('popup-content'); ?>
  <?php echo $__env->make('bed_category.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('bed_category.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('bed_category._script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
    $(function() {
      ...
      var table = $('#bed-category-table').DataTable({
        ...
        ajax: {
          url: '<?php echo e(route("admin.bed-category.get")); ?>',
          type: 'get',
