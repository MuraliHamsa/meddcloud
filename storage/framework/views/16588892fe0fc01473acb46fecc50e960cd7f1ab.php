...
<?php $__env->startSection('content'); ?>
    ...
    <div class="register-box">
        <div class="register-logo">
            <a href="<?php echo e(route('admin.home')); ?>"><b>Admin</b>LTE</a>
        </div>
        ...
        <div class="register-box-body">
            ...
            <form action="<?php echo e(url('/register')); ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="<?php echo e(trans('adminlte_lang::message.fullname')); ?>" name="username" value="<?php echo e(old('username')); ?>"/>
