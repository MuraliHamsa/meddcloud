    ...
    @foreach ($payment_category as $category)
        <div class="col-md-12 payment" id="pushtoright">
            <div class="col-md-3 payment_label" style="width: 50%">
                ...
                <i id="{{ $category->id}}" class="fa fa-plus-circle category-add fa-2x" title="Add {{ $category->category }} to final bill " style="color: green;cursor: hand;cursor: pointer; float: right;"></i>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.category-add').click(function (){
            ...
            $.ajax({
                url: "{{ route('admin.payment.getpayment') }}",
                method: 'GET',
