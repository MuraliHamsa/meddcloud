...
<div class="box-body">
  <div class="form-group">
    <label class="col-lg-2 control-label">
      {{ trans('validation.attributes.backend.financial-activities.payment.patient_id') }}
      <span class="required">*</span>
    </label>
    <div class="col-lg-4">
      {{ Form::select('patient_id', $poption, @$payment->patient_id, ['class' => 'form-control']) }}
    </div>

    <label class="col-lg-2 control-label">
      {{ trans('validation.attributes.backend.financial-activities.payment.payment_billing') }}
      <span class="required">*</span>
    </label>
    <div class="col-lg-4">
      {{ Form::select('payment_billing', $option, '', ['class' => 'form-control', 'id' => 'billingtype']) }}
    </div>
  </div>
  ...
  <div class="row">
      ...
      <div id="temp_payments">
        @if(!empty($payment_category))
          @foreach($payment_category as $category)
            <div class="col-md-12 payment">
              <div class="col-md-3 payment_label" style="width:50%">
                <label>{{ ucfirst($category->category) }}</label>
                <i id="{{ $category->id }}" class="fa fa-plus-circle fa-2x category-add" title="Add {{ $category->id }} to final bill " style="color: green;cursor: hand;cursor: pointer; float: right;"></i>
              </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="col-md-12 payment">
        ...
        <div class="col-md-9" style="width: 50%">
          <input type="text" class="form-control pay_in" name="discount" placeholder="Discount" value="{{ @$payment->discount }}">
        </div>
      </div>
      ...
      <div class="col-md-12 payment">
        ...
        <div class="col-md-9" style="width: 50%">
          <input type="text" class="form-control pay_in" name="vat" value="{{ @$payment->vat }}" placeholder="%">
        </div>
      </div>
    </div>
  </div>
...
<div class="box-footer">
  {{ Form::submit('Generate Bill', ['class' => 'btn btn-info']) }}
</div>