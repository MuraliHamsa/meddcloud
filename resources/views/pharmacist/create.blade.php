  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Add Pharmacist</h4>
      </div>
      <div class="modal-body">
        {{ Form::open(['route' => 'admin.pharmacist.store', 'class' => 'form-horizontal', 'id' => 'pharmacistval', 'method' => 'post', 'files'=>true]) }}
