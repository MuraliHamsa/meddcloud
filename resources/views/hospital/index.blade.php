...
@section ('htmlheader_title', trans('labels.backend.hospital.title'))

@section ('contentheader_title', trans('labels.backend.hospital.title'))
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              {{ trans('labels.backend.hospital.create') }}
            </button>
          </a>
        </div>
        <div class="box-body">
          <table id="hospital-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th></th>
                <th> {{ trans('labels.backend.hospital.table.title') }} </th>
                <th> {{ trans('labels.backend.hospital.table.email') }} </th>
                <th> {{ trans('labels.backend.hospital.table.address') }} </th>
                <th> {{ trans('labels.backend.hospital.table.phone') }} </th>
