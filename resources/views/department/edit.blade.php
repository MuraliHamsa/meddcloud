  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ Form::open(['route' => 'admin.department.update', 'class' => 'form-horizontal', 'id' => 'editDepartmentForm', 'method' => 'post']) }}
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              {{ Form::textarea('description', null, ['class' => 'form-control description', 'id' => 'edit-description', 'placeholder' => trans('validation.attributes.backend.department.description')]) }}
            </div>
          </div>
