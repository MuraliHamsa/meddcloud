  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ Form::open(['route' => 'admin.doctor.store', 'class' => 'form-horizontal', 'id' => 'doctorval', 'method' => 'post', 'files'=>true]) }}
          ...
          <div class="form-group">
            <label class="col-lg-2 control-label">
              {{ trans('validation.attributes.backend.doctor.profile') }} 
            </label>
            <div class="col-lg-10">
              {{ Form::text('profile', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.doctor.profile')]) }}
            </div>
          </div>
