  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{ Form::open(['route' => 'admin.bed.store', 'class' => 'form-horizontal', 'id' => 'editBedForm', 'method' => 'post']) }}
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              {{ Form::text('description', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.bed.bed.decsription')]) }}
            </div>
          </div>
