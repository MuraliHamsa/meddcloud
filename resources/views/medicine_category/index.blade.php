...
@section ('htmlheader_title', trans('labels.backend.medicine.medicine-category.title'))

@section ('contentheader_title', trans('labels.backend.medicine.medicine-category.title'))
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              {{ trans('labels.backend.medicine.medicine-category.create') }}
            </button>
          </a>
        </div>
        ...
        <div class="box-body">
          <table id="medicine-category-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> {{ trans('labels.backend.medicine.medicine-category.table.name') }} </th>
                <th> {{ trans('labels.backend.medicine.medicine-category.table.description') }} </th>
...
@section('popup-content')
  @include('medicine_category.create')

  @include('medicine_category.edit')

  @include('medicine_category._script')
  ...
  <script>
    $(function() {
      ...
      var table = $('#medicine-category-table').DataTable({
        ...
        ajax: {
          url: '{{ route("admin.medicine-category.get") }}',
          type: 'get',
