...
@section ('htmlheader_title', trans('labels.backend.financial-activities.expense.title'))

@section ('contentheader_title', trans('labels.backend.financial-activities.expense.title'))
        ...
        <div class="box-header" id="action-buttons">
          <a data-toggle="modal" href="#myModal">
            <button type="button" class="btn btn-primary">
              ...
              {{ trans('labels.backend.financial-activities.expense.create') }}
            </button>
          </a>
        </div>
        ...
        <div class="box-body">
          <table id="expense-table" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>  </th>
                <th> {{ trans('labels.backend.financial-activities.expense.table.category') }} </th>
                <th> {{ trans('labels.backend.financial-activities.expense.table.created_at') }} </th>
                <th> {{ trans('labels.backend.financial-activities.expense.table.amount') }} </th>
